...
public class MainPanel : MonoBehaviour
{
    ...
    private void Sound()
    {
        ...
        {
            btn_Sound.transform.GetChild(0).GetComponentInChildren<Image>().sprite = vars.musicOn;
        }
        else
        {
            btn_Sound.transform.GetChild(0).GetComponentInChildren<Image>().sprite = vars.musicOff;
        }
