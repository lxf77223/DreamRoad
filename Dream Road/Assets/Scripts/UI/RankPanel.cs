...
public class RankPanel : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        btn_Close.GetComponent<Image>().color = new Color(btn_Close.GetComponent<Image>().color.r,
    ...
    private void Show()
    {
        ...
        btn_Close.GetComponent<Image>().DOColor(new Color(btn_Close.GetComponent<Image>().color.r,
            btn_Close.GetComponent<Image>().color.g,
    ...
    private void OnCloseButtonClick()
    {
        ...
        btn_Close.GetComponent<Image>().DOColor(new Color(btn_Close.GetComponent<Image>().color.r,
            btn_Close.GetComponent<Image>().color.g,
            btn_Close.GetComponent<Image>().color.b, 0f), 0.3f);
